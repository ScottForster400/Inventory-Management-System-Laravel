        ...
        if($alreadyExist != null){
            ...
            if($inBranch !=null){
                ...
                session()->flash('success',"{$request->name} already exists updated stock count with specified amount ");
                    // Returns user to main Stock view
    ...
    public function update(Request $request, int $product)
    {
        ...
        if ($request->file('img')){
                    ...
                    // if ($request->file('img')) {
                        ...
                        //Returns user to main Stock view
                         return to_route('stocks.index',['success'=>"{$selectedProduct->name} successfully removed"]);
                    // }
                    // return redirect()->route('stocks.index')->with('error', 'Image upload failed.');
                }
