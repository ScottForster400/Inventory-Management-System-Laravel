                    ...
                    <x-table-body>
                        ...
                        <x-tr class="max-sm:flex max-sm:flex-col">
                            ...
                            <x-td>
                                ...
                                <x-text-input id="game-length" type="number" name="game_length" min=0 class="w-full basis-1/2" value="{{$product->game_length}}"></x-text-input>
                                @error('game-length')
                                    <x-error-message-form>{{$message}}</x-error-message-form>
                                @enderror
                            </x-td>
                        ...
                        <x-tr class="max-sm:flex max-sm:flex-col">
                            <x-td>
                                ...
                                <x-text-input id="max_players" type="number" name="max-players" min=0 class="w-full basis-1/2" value="{{$product->maximum_player_count}}"></x-text-input>
                                @error('max-players')
                                    <x-error-message-form>{{$message}}</x-error-message-form>
                                @enderror
                            </x-td>
