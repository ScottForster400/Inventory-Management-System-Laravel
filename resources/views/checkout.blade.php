    ...
    @if ($carts)
        <div class="flex flex-row flex-wrap justify-center items-center w-full">
            @foreach ($carts as $cart)
                <div class="flex md:flex-col max-md:min-w-64 max-md:w-2/5 max-md:flex-row max-md:flex-wrap justify-center items-center w-1/4 bg-white border border-gray-500 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 m-4">
